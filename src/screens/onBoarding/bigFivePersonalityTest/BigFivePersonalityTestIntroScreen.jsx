...
const BigFivePersonalityTestIntroScreen = () => {
        ...
        <Box
          ...
          <Box
            ...
            <Typography
              ...
              experience according to your personality.
            </Typography>
          </Box>
          ...
          <Box
            ...
            <CustomButton
              ...
              onClick={() => {
                navigate(ROUTES.ON_BOARDING.BIG_FIVE_PERSONALITY.QUESTIONS);
              }}
            />
          </Box>
        </Box>
...
export default BigFivePersonalityTestIntroScreen;
