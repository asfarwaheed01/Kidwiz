...
const ValuesAssessmentTestIntroScreen = () => {
        ...
        <Box
          ...
          <Box
            ...
            <Typography
              ...
              experience according to your values.
            </Typography>
          </Box>
          ...
          <Box
            ...
            <CustomButton
              ...
              onClick={() => {
                navigate(ROUTES.ON_BOARDING.VALUES_ASSESSMENT.QUESTIONS);
              }}
            />
          </Box>
        </Box>
...
export default ValuesAssessmentTestIntroScreen;
